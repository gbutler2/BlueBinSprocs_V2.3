...
/****** Object:  StoredProcedure [dbo].[sp_BlueBinRefresh]    Script Date: 12/7/2015 2:31:35 PM ******/
SET ANSI_NULLS ON
GO
...
if exists (select * from dbo.sysobjects where id = object_id(N'sp_BlueBinRefresh') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure sp_BlueBinRefresh
GO

CREATE PROCEDURE [dbo].[sp_BlueBinRefresh] 
